    ...
    <MobileLayout>
      ...
      {editScan && (
        <div style={{position:'fixed',top:0,left:0,right:0,bottom:0,zIndex:1000,display:'flex',flexDirection:'column',justifyContent:'flex-end'}}>
          ...
          <div style={{position:'relative',backgroundColor:'white',borderRadius:'20px 20px 0 0',padding:'20px 20px 30px',maxHeight:'75vh',overflowY:'auto'}}>
      ...
      <div style={{backgroundColor:primary,padding:'16px 20px 20px'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:'6px',marginTop:'14px'}}>
          {[
            ...
            {label:'🤝 Warm',value:stats.warm,bg:'rgba(186,117,23,0.35)'},
            ...
            <div key={scan.id} style={{backgroundColor:'white',border:'1px solid #eee',borderRadius:'12px',marginBottom:'8px'}}>
              ...
              {expandedScan===scan.id && (
                <div style={{borderTop:'1px solid #f0f0f0',padding:'12px 16px'}}>
                  ...
                  {/* Contacts with phone + WhatsApp icons */}
                        ...
                        <div key={c.id} style={{padding:'8px 10px',backgroundColor:'#fafafa',borderRadius:'8px',marginBottom:'6px'}}>
                          ...
                          {[c.phone1, c.phone2, c.phone3].filter(Boolean).map((ph:string, j:number) => (
                            <div key={j} style={{display:'flex',alignItems:'center',gap:'6px',marginBottom:'6px'}}>
                              <span style={{fontSize:'12px',color:'#333',flex:1}}>{ph}</span>
                              <a href={'tel:'+ph} style={{display:'inline-flex',alignItems:'center',justifyContent:'center',width:'30px',height:'30px',borderRadius:'50%',backgroundColor:'#EAF3DE',textDecoration:'none',fontSize:'14px',flexShrink:0}}>📞</a>
                              <a href={'https://wa.me/91'+ph.replace(/\D/g,'')} target="_blank" rel="noreferrer" style={{display:'inline-flex',alignItems:'center',justifyContent:'center',width:'30px',height:'30px',borderRadius:'50%',backgroundColor:'#E7F7EE',textDecoration:'none',fontSize:'14px',flexShrink:0}}>💬</a>
                            </div>
                          ))}
                          {c.email && (
                            <div style={{display:'flex',alignItems:'center',gap:'6px'}}>
                              <span style={{fontSize:'12px',color:'#333',flex:1}}>{c.email}</span>
                              <a href={'mailto:'+c.email} style={{display:'inline-flex',alignItems:'center',justifyContent:'center',width:'30px',height:'30px',borderRadius:'50%',backgroundColor:'#E6F1FB',textDecoration:'none',fontSize:'14px',flexShrink:0}}>✉️</a>
                            </div>
                          )}
                        </div>
                      ))}
