        ...
        {result && (
          <div style={{backgroundColor:'white',border:'1px solid #eee',borderRadius:'12px',padding:'20px',marginBottom:'16px'}}>
            ...
            <div style={{marginTop:'16px'}}>
              ...
              <textarea value={note} onChange={e=>setNote(e.target.value)} placeholder="Add a note about this contact..." style={{width:'100%',padding:'10px',borderRadius:'8px',border:'1px solid #ddd',fontSize:'13px',resize:'vertical',minHeight:'80px',fontFamily:'sans-serif',boxSizing:'border-box'}} />
            </div>
